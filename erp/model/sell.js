...
data.fieldList = [
  ...
  { name: 'shop_id', title: '商店', selectList: [] },
  ...
  { name: 'pay_time', title: '支付时间', sort: 0, type: 'time', changeable: true, width: '120' },
  { name: 'discount', title: '折扣', width: '60' },
  { name: 'user_phone', title: '收件人电话', changeable: true, width: '100' },
  ...
  { name: 'logistics', title: '物流单号', changeable: true },
  ...
  { name: 'order_time', title: '下单时间', type: 'time', changeable: true, width: '120' },
