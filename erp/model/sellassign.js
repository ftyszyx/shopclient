...
data.fieldList = [
  ...
  { name: 'close_status', title: '废弃状态', sort: 0, selectList: global.deleteStatus, width: '80px' },
  ...
  { name: 'del_info', title: '废弃原因', search: 'LIKE' },
  { name: 'info', title: '备注', changeable: true, type: 'text' }
]
