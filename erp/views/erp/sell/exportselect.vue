      ...
      <div class="header">
        ...
        <div class="content">
          <div class="select-box temple-select-box">
              ...
              <button v-show="selectTempleIndex>0&&authDic.Export_del.auth" @click="delTemple()" class="button-common">删除选中模板</button>
          </div>
        ...
        <div class="footer">
          ...
          <button v-show="authDic.Export_edit.auth" @click="saveTemple()" class="button-common">保存模板</button>
        </div>
    </div>
 </div>
</template>
