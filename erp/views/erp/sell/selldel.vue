<template>
    <div>
      <sell  :searchConditon="SearchCondition" :showSearchFiled="SearchFiled" ></sell>
    </div>
</template>
...
export default{
  data() {
    return {
      SearchFiled: ['shop_order', 'item_name', 'store_id', 'item_short_name', 'num',
      ...
      SearchCondition: { status: global.sellStatus_delete }
    }
  },
  components: {
    Sell
