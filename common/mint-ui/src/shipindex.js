...
// import Navbar from '../packages/navbar'; // 头部分页
// import Tabbar from '../packages/tabbar';
// import Search from '../packages/search'; // 搜索
// import Checklist from '../packages/checklist';
// import Radio from '../packages/radio';
// import Loadmore from '../packages/loadmore';
// import Actionsheet from '../packages/actionsheet';
// import Popup from '../packages/popup';
// import Swipe from '../packages/swipe'; // 轮播图
// import SwipeItem from '../packages/swipe-item';
// import Range from '../packages/range';
// import Picker from '../packages/picker'; // 选地址
// import Progress from '../packages/progress';
import Toast from '../packages/toast';
import Indicator from '../packages/indicator'; // 加载圈
