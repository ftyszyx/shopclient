...
<script>
import Vue from 'vue';
import util from 'common/utils/base.js';
...
export default {
  ...
  methods: {
    ...
    handleInputChange(value) {
      ...
      let filteredFlatOptions = flatOptions.filter(optionsStack => optionsStack.some(option => new RegExp(value, 'i').test(option[this.labelKey])));
